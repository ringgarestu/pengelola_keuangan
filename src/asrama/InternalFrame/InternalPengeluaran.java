 ...
 *
 */
public class InternalPengeluaran extends javax.swing.JInternalFrame {
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        DialogPengeluaran.status_dialog = "new";
        DialogPengeluaran dc = new DialogPengeluaran();
        dc.setVisible(true);
        addQuery = "and (idbayardenda like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
        getDataPengeluaran(addQuery);
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        DialogPengeluaran.status_dialog = "edit";
        DialogPengeluaran dc = new DialogPengeluaran();
        dc.setVisible(true);
        addQuery = " and (idbayardenda like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
        getDataPengeluaran(addQuery);
    ...
    public void createTablePengeluaran(){
        ...
        Object[] row = {"ID Pengeluaran","Keterangan","Tanggal Bayar","Jumlah"};
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogPengeluaran.static_id_bayar_kamar_old = select_id_bayar_kamar;
                    DialogPengeluaran.status_dialog = "edit";
                    DialogPengeluaran dp = new DialogPengeluaran();
                    dp.setVisible(true);
                    addQuery = "and (idpengeluaran like ('%"+filterName.getText()+"%'))";
                    getDataPengeluaran(addQuery);
                }
            }
        });
