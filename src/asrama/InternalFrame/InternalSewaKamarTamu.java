 ...
 *
 */
public class InternalSewaKamarTamu extends javax.swing.JInternalFrame {
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        DialogSewaKamarTamu.status_dialog = "new";
        DialogSewaKamarTamu dc = new DialogSewaKamarTamu();
        dc.setVisible(true);
        addQuery = "and (no_invoice like ('%"+filterName.getText()+"%') or kamar_code like ('%"+filterName.getText()+"%'))";
        getDataSewaKamar(addQuery);
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        DialogSewaKamarTamu.status_dialog = "edit";
        DialogSewaKamarTamu dc = new DialogSewaKamarTamu();
        dc.setVisible(true);
        addQuery = " and (no_invoice like ('%"+filterName.getText()+"%') or kamar_code like ('%"+filterName.getText()+"%'))";
        getDataSewaKamar(addQuery);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sql = "delete from sewakamartamu where no_invoice='"+select_no_invoice+"'";
    ...
    public void createTableSewaKamar(){
        ...
        Object[] row = {"No Invoice","Kode Kamar","ID Pelanggan","Tanggal Mulai","Tanggal Sampai",
            "Biaya","Status"};
    ...
    public void getDataSewaKamar(String addQuery){
        ...
        try {
            ...
            while(rs.next()){
                ...
                String [] in_table = {no_invoice,kamar_code,cust_id,tglmulai,tglsampai,biaya,status};
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogSewaKamarTamu.static_no_invoice_old = select_no_invoice;
                    DialogSewaKamarTamu.status_dialog = "edit";
                    DialogSewaKamarTamu dp = new DialogSewaKamarTamu();
                    dp.setVisible(true);
                    addQuery = "and (no_invoice like ('%"+filterName.getText()+"%') or kamar_code like ('%"+filterName.getText()+"%'))";
                    getDataSewaKamar(addQuery);
                }
