...
public class InternalKamar extends javax.swing.JInternalFrame {
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        DialogKamar.status_dialog = "new";
        DialogKamar dc = new DialogKamar();
        dc.setVisible(true);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sql = "delete from kamar where kamar_id='"+select_kamar_id+"'";
    ...
    public void getDataKamar(String addQuery){
        clearTable();
        try {
            String sql = "select *from kamar "+addQuery+" order by kamar_id";
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogKamar.static_kamar_id_old = select_kamar_id;
                    DialogKamar.status_dialog = "edit";
                    DialogKamar dc = new DialogKamar();
                    dc.setVisible(true);
                    addQuery = "where (kamar_id like ('%"+filterName.getText()+"%') or kamar_name like ('%"+filterName.getText()+"%'))";
                    getDataKamar(addQuery);
