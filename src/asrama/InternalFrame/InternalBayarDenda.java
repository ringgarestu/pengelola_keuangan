 ...
 * 
 */
public class InternalBayarDenda extends javax.swing.JInternalFrame {
    ...
    private void filterNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_filterNameKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            addQuery = "and (idbayardenda like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        DialogBayarDenda.status_dialog = "new";
        DialogBayarDenda dc = new DialogBayarDenda();
        dc.setVisible(true);
        addQuery = "and (idbayardenda like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
        getDataBayarDenda(addQuery);
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        DialogBayarDenda.status_dialog = "edit";
        DialogBayarDenda dc = new DialogBayarDenda();
        dc.setVisible(true);
        addQuery = " and (idbayardenda like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
        getDataBayarDenda(addQuery);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sql = "delete from bayardenda where idbayardenda='"+select_id_bayar_kamar+"'";
...
//                mengambil parameter dari ireport
    ...
    public void createTableBayarDenda(){
        ...
        Object[] row = {"ID Bayar Denda","No Invoice","Tanggal Bayar","Biaya","Jumlah",
            "Keterangan"};
    ...
    public void getDataBayarDenda(String addQuery){
        clearTable();
        try {
            String sql = "select * from bayardenda";
            ResultSet rs = conn.createStatement().executeQuery(sql);
            while(rs.next()){
                String idbayarkamar = rs.getString("idbayardenda");
                ...
                String [] in_table = {idbayarkamar,no_invoice,tanggalbayar,biaya,jumlah,keterangan};
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogBayarDenda.static_id_bayar_kamar_old = select_id_bayar_kamar;
                    DialogBayarDenda.status_dialog = "edit";
                    DialogBayarDenda dp = new DialogBayarDenda();
                    dp.setVisible(true);
                    addQuery = "and (idbayardenda like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
                    getDataBayarDenda(addQuery);
                }
