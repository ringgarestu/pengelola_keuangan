 ...
 * 
 */
public class DialogSewaKamar extends javax.swing.JDialog {
    ...
    public DialogSewaKamar() {
        super(new Frame(), "Sewa Kamar Detail", true);
        initComponents();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(No_Invoice, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jMulai, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jSampai, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE))))
    ...
    private void buttonSave1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSave1ActionPerformed
        if(status_dialog.equalsIgnoreCase("new")){
            try {
                ...
                Logger.getLogger(DialogSewaKamar.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else if (status_dialog.equalsIgnoreCase("edit")){
            SaveEditSewaKamar();
        }
    ...
    public void createNoInvoice(){
        try {
            String sql = "select coalesce(max(no_invoice)+1,1010001) as max_no_invoice from sewakamar";
            ResultSet rs = conn.createStatement().executeQuery(sql);
            if(rs.next()){
    ...
    public void SaveNewSewaKamar() throws SQLException{
        if (!"".equals(cbKamar.getSelectedItem().toString()) &&
            ...
            String sql = "insert into sewakamar values (?,?,?,?,?,?,?)";
    ...
    public void SaveEditSewaKamar(){
        try {
            String sql = "update sewakamar set no_invoice=?,kamar_code=?,kodeanggota=?,tglmulai=?,tglsampai=?,biaya=?, "
    ...
    public void getDetailSewaKamar(){
        try{
            String sql = "select *from sewakamar where no_invoice='"+static_no_invoice_old+"'";
            ResultSet rs = conn.createStatement().executeQuery(sql);
            while(rs.next()){
