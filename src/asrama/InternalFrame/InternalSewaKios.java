 ...
 *
 */
public class InternalSewaKios extends javax.swing.JInternalFrame {
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sql = "delete from sewakios where no_invoice='"+select_no_invoice+"'";
    ...
    public void createTableSewaKios(){
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogSewaKios.static_no_invoice_old = select_no_invoice;
                    DialogSewaKios.status_dialog = "edit";
