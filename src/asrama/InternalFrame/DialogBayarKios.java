 ...
 * 
 */
public class DialogBayarKios extends javax.swing.JDialog {
    ...
    public DialogBayarKios() {
        super(new Frame(), "Bayar Kios Detail", true);
        initComponents();
    ...
    private void initComponents() {
        ...
        IdBayarKios = new javax.swing.JTextField();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(IdBayarKios, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3))
    ...
    private void cbInvoiceItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbInvoiceItemStateChanged
        try {
            ...
            String sql = "select sewakios.*,customer.nama_cust from sewakios,customer where sewakios.cust_id=customer.cust_id and no_invoice='"+cbInvoice.getSelectedItem().toString()+"'";
            ResultSet rs = conn.createStatement().executeQuery(sql);
            while(rs.next()){
                Kios.setText(rs.getString("kios_code"));
    ...
    private void buttonSave1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSave1ActionPerformed
        if(status_dialog.equalsIgnoreCase("new")){
            try {
                ...
                Logger.getLogger(DialogBayarKios.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else if (status_dialog.equalsIgnoreCase("edit")){
            SaveEditBayarKios();
        }
 ...
 //               Denda.setText(Tempo);
    ...
    public void createIdBayarKios(){
        try {
            String sql = "select coalesce(max(no_invoice)+1,7010001) as max_id_bayar_kamar from sewakios";
            ResultSet rs = conn.createStatement().executeQuery(sql);
            if(rs.next()){
                IdBayarKios.setText(rs.getString("max_id_bayar_kamar"));
            }
        }catch(Exception e){e.printStackTrace();}
    }
    
    public void SaveNewBayarKios() throws SQLException{
    ...
    public void SaveEditBayarKios(){
        try {
            String sql = "update bayarkios set idbayarkios=?, no_invoice=?,tanggalbayar=?,denda=?,jumlah=?, "
                    + "keterangan=? where idbayarkios='"+static_id_bayar_kamar_old+"'";
            PreparedStatement ps = conn.prepareStatement(sql);
            try {
                ps.setString(1, IdBayarKios.getText());
                ps.setString(2, cbInvoice.getSelectedItem().toString());
    ...
    public void getDetailBayarKios(){
        try{
            String sql = "select *from bayarkios where idbayarkios='"+static_id_bayar_kamar_old+"'";
            ResultSet rs = conn.createStatement().executeQuery(sql);
            while(rs.next()){
    ...
    private javax.swing.JTextField IdBayarKios;
