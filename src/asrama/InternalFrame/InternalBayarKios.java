 ...
 *
 */
public class InternalBayarKios extends javax.swing.JInternalFrame {
    ...
    private void filterNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_filterNameKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            addQuery = "and (idbayarkios like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        DialogBayarKios.status_dialog = "new";
        DialogBayarKios dc = new DialogBayarKios();
        dc.setVisible(true);
        addQuery = "and (idbayarkios like ('%"+filterName.getText()+"%') or no_invoicelike ('%"+filterName.getText()+"%'))";
        getDataBayarKios(addQuery);
    }//GEN-LAST:event_buttonAddActionPerformed

    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        DialogBayarKios.status_dialog = "edit";
        DialogBayarKios dc = new DialogBayarKios();
        dc.setVisible(true);
        addQuery = " and (idbayarkios like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
        getDataBayarKios(addQuery);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sql = "delete from bayarkios where idbayarkios='"+select_id_bayar_kamar+"'";
...
//                mengambil parameter dari ireport
    ...
    public void getDataBayarKios(String addQuery){
        clearTable();
        try {
            String sql = "select * from bayarkios";
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogBayarKios.static_id_bayar_kamar_old = select_id_bayar_kamar;
                    DialogBayarKios.status_dialog = "edit";
                    DialogBayarKios dp = new DialogBayarKios();
                    dp.setVisible(true);
                    addQuery = "and (idbayarkios like ('%"+filterName.getText()+"%') or no_invoice like ('%"+filterName.getText()+"%'))";
                    getDataBayarKios(addQuery);
                }
