 ...
 *
 */
public class InternalPelanggaran extends javax.swing.JInternalFrame {
    ...
    public InternalPelanggaran() {
        initComponents();
        nf.setMaximumFractionDigits(0);
        nf.setMinimumFractionDigits(0);
        createTablePelanggaran();
        addListener();
        getDataPelanggaran("");
    }
    ...
    private void filterNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_filterNameKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            addQuery = "and (no_invoice like ('%"+filterName.getText()+"%') or kodeanggota like ('%"+filterName.getText()+"%'))";
            getDataPelanggaran(addQuery);
        }
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        DialogPelanggaran.status_dialog = "new";
        DialogPelanggaran dc = new DialogPelanggaran();
        dc.setVisible(true);
        addQuery = "and (no_invoice like ('%"+filterName.getText()+"%') or kodeanggota like ('%"+filterName.getText()+"%'))";
        getDataPelanggaran(addQuery);
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        DialogPelanggaran.status_dialog = "edit";
        DialogPelanggaran dc = new DialogPelanggaran();
        dc.setVisible(true);
        addQuery = " and (no_invoice like ('%"+filterName.getText()+"%') or kodeanggota like ('%"+filterName.getText()+"%'))";
        getDataPelanggaran(addQuery);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sql = "delete from pelanggaran where no_invoice='"+select_no_invoice+"'";
    ...
    public void createTablePelanggaran(){
    ...
    public void getDataPelanggaran(String addQuery){
        clearTable();
        try {
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getClickCount()==2){
                    DialogPelanggaran.static_no_invoice_old = select_no_invoice;
                    DialogPelanggaran.status_dialog = "edit";
                    DialogPelanggaran dp = new DialogPelanggaran();
                    dp.setVisible(true);
                    addQuery = "and (no_invoice like ('%"+filterName.getText()+"%') or kodeanggota like ('%"+filterName.getText()+"%'))";
                    getDataPelanggaran(addQuery);
                }
